...
public class NajpocetnejsieDruhPripadu extends JDialog implements LoadDataForTable {
    private JPanel contentPane;
    private JTable my_table;
    private DB_Stats dbAccess;

    public NajpocetnejsieDruhPripadu() {
    ...
    public void loadData() {
        new SwingWorker<List, RuntimeException>() {
            ...
            protected List doInBackground() throws Exception {
                return dbAccess.getStatsDruhPripadu();
            }
    ...
    public String toString() {
        return "Najpocetnejsie trestne ciny podla druhu pripadu.";
    }
}
